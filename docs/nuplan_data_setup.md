...
单场景烟测通过后，可以使用项目脚本跑 5 个 mini 场景并自动汇总结果:
...
当前 5 场景评估结果: 成功 5、失败 0、final weighted score 为 0.9254。

更多流程见 [mini_eval_workflow.md](mini_eval_workflow.md)。
...
- 已完成 1 场景 smoke test 和 5 场景 mini closed-loop evaluation。
